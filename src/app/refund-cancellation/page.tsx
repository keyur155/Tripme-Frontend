        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8 sm:mb-12">
            <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-[#F5E6D3] rounded-xl sm:rounded-2xl mb-4 sm:mb-6">
              <RefreshCw className="text-[#C45D3E] w-6 h-6 sm:w-8 sm:h-8" />
            </div>
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8 md:p-12 lg:p-16">
            <div className="prose prose-lg max-w-none">
              <div className="space-y-6 sm:space-y-8 text-gray-700 leading-relaxed">
                  ...
                  <div className="space-y-4">
                    <div>
                      <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 flex items-center">
                        <Clock className="text-[#C45D3E] mr-2 flex-shrink-0 w-4 h-4 sm:w-5 sm:h-5" />
                    ...
                    <div>
                      <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 flex items-center">
                        <XCircle className="text-[#C45D3E] mr-2 flex-shrink-0 w-4 h-4 sm:w-5 sm:h-5" />
                ...
                <section className="bg-[#FDF8F3] rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-[#F5E6D3]">
                  <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 flex items-center">
                    <span className="w-2 h-2 bg-[#C45D3E] rounded-full mr-2 sm:mr-3 flex-shrink-0"></span>
                ...
                <section className="bg-[#FDF8F3] rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-[#F5E6D3]">
                  ...
                  <ul className="list-none space-y-2 ml-2 sm:ml-4">
                    <li className="flex items-center">
                      ...
                      <a href="mailto:support@tripmeglobal.com" className="text-[#C45D3E] hover:text-[#A84B32] font-medium text-sm sm:text-base break-all">support@tripmeglobal.com</a>
                    </li>
                    <li className="flex items-center">
                      <span className="text-[#C45D3E] mr-2 sm:mr-3">🌐</span>
                      <a href="https://www.tripmeglobal.com" target="_blank" rel="noopener noreferrer" className="text-[#C45D3E] hover:text-[#A84B32] font-medium text-sm sm:text-base break-all">www.tripmeglobal.com</a>
                    </li>
                  </ul>
                </section>
              </div>
