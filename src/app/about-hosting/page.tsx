        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12 sm:mb-16 text-center">
            <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-[#F5E6D3] rounded-xl sm:rounded-2xl mb-4 sm:mb-6">
              <Home className="text-[#C45D3E] w-6 h-6 sm:w-8 sm:h-8" />
            </div>
          ...
          <div className="space-y-8 sm:space-y-12">
            ...
            <section className="bg-[#FDF8F3] rounded-2xl sm:rounded-3xl shadow-sm border border-[#F5E6D3] p-6 sm:p-8 md:p-12">
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-[#F5E6D3]">
                <div className="flex items-center mb-3 sm:mb-4">
                  <CheckCircle className="text-[#C45D3E] mr-2 sm:mr-3 flex-shrink-0 w-5 h-5 sm:w-6 sm:h-6" />
              ...
              <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
                {['Homes & apartments', 'Villas & holiday homes', 'Studio units', 'Serviced residences', 'Unique stays (subject to approval)'].map((item, index) => (
                  <div key={index} className="flex items-center bg-gray-50 rounded-xl p-3 sm:p-4 border border-gray-200">
                    <CheckCircle className="text-[#C45D3E] mr-2 sm:mr-3 flex-shrink-0 w-4 h-4 sm:w-5 sm:h-5" />
            ...
            <section className="bg-[#FDF8F3] rounded-2xl sm:rounded-3xl shadow-sm border border-[#F5E6D3] p-6 sm:p-8 md:p-12">
              <div className="flex items-center mb-4 sm:mb-6">
                <Shield className="text-[#C45D3E] mr-2 sm:mr-3 flex-shrink-0 w-6 h-6 sm:w-7 sm:h-7" />
              ...
              <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
                {['Set your own pricing', 'Choose your cancellation policy', 'Define house rules', 'Accept or decline bookings', 'Block dates anytime'].map((item, index) => (
                  <div key={index} className="flex items-center bg-white rounded-xl p-3 sm:p-4 border border-[#F5E6D3]">
                    <CheckCircle className="text-[#C45D3E] mr-2 sm:mr-3 flex-shrink-0 w-4 h-4 sm:w-5 sm:h-5" />
                    <span className="text-sm sm:text-base text-gray-700">{item}</span>
                  </div>
                ))}
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <section className="bg-[#FDF8F3] rounded-2xl sm:rounded-3xl shadow-sm border border-[#F5E6D3] p-6 sm:p-8">
                <div className="flex items-center mb-3 sm:mb-4">
                  <Users className="text-[#C45D3E] mr-2 sm:mr-3 flex-shrink-0 w-5 h-5 sm:w-6 sm:h-6" />
            ...
            <section className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8 md:p-12">
              <div className="flex items-center mb-4 sm:mb-6">
                <FileText className="text-[#C45D3E] mr-2 sm:mr-3 flex-shrink-0 w-6 h-6 sm:w-7 sm:h-7" />
              ...
              <div className="space-y-3 sm:space-y-4">
                {[
                  ...
                  <div key={item.step} className="flex items-start bg-gray-50 rounded-xl p-4 sm:p-5 border border-gray-200">
                    <div className="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 bg-[#C45D3E] text-white rounded-full flex items-center justify-center font-bold mr-3 sm:mr-4 text-sm sm:text-base">
                      {item.step}
                    </div>
            ...
            {/* Call to Action */}
            <section className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border-2 border-[#F5E6D3] p-6 sm:p-8 md:p-12 text-center">
              ...
              <Link
                href="/become-host"
                className="inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-[#C45D3E] to-[#A84B32] text-white rounded-xl font-semibold hover:from-[#A84B32] hover:to-[#8B3D28] transition-all shadow-lg hover:shadow-xl text-sm sm:text-base"
              >
                Become a Host
              </Link>
            </section>
