    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
      ...
      <div className="pt-20 sm:pt-24 pb-12 sm:pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Link 
            href="/" 
            className="inline-flex items-center text-[#C45D3E] hover:text-[#C45D3E] mb-6 sm:mb-8 transition-colors group"
          >
          ...
          <div className="mb-8 sm:mb-12">
            <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-[#F5E6D3] to-[#F5E6D3] rounded-xl sm:rounded-2xl mb-4 sm:mb-6">
              <Shield className="text-[#C45D3E] w-6 h-6 sm:w-8 sm:h-8" />
            </div>
              ...
              <div className="space-y-6 sm:space-y-8 text-gray-700 leading-relaxed">
                <section className="border-l-4 border-[#C45D3E] pl-4 sm:pl-6">
                  <p className="text-base sm:text-lg text-gray-600">
                    This Privacy Policy is currently being updated. Please refer to our Terms & Conditions for information about how we handle your data, or contact us at <a href="mailto:support@tripmeglobal.com" className="text-[#C45D3E] hover:text-[#C45D3E] font-medium break-all">support@tripmeglobal.com</a> for any privacy-related concerns.
                  </p>
                </section>

                <section className="bg-gradient-to-r from-[#FDF8F3] to-[#FDF8F3] rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-[#F5E6D3]">
                  ...
                  <ul className="list-none space-y-2 ml-2 sm:ml-4">
                    <li className="flex items-center">
                      <span className="text-[#C45D3E] mr-2 sm:mr-3">📧</span>
                      <a href="mailto:support@tripmeglobal.com" className="text-[#C45D3E] hover:text-[#C45D3E] font-medium text-sm sm:text-base break-all">support@tripmeglobal.com</a>
                    </li>
                    <li className="flex items-center">
                      <span className="text-[#C45D3E] mr-2 sm:mr-3">🌐</span>
                      <a href="https://www.tripmeglobal.com" target="_blank" rel="noopener noreferrer" className="text-[#C45D3E] hover:text-[#C45D3E] font-medium text-sm sm:text-base break-all">www.tripmeglobal.com</a>
                    </li>
                  </ul>
                </section>
              </div>
