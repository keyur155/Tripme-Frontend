                  ...
                  <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs text-green-600">
                        {booking.timeSlot ? formatTime(booking.timeSlot.endTime) : (booking.listing?.checkOutTime || '11:00 AM')}
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                ...
                {/* Cleaning Fee */}
                {booking.listing?.pricing?.cleaningFee > 0 && (
                  <div className="flex justify-between items-center py-2">
                ...
                {/* Security Deposit */}
                {booking.listing?.pricing?.securityDeposit > 0 && (
                  <div className="flex justify-between items-center py-2">
                ...
                <div className="border-t border-gray-200 pt-3">
                  <div className="flex justify-between items-center py-3 bg-green-50 rounded-lg px-3">
                    <span className="text-base font-semibold text-green-800">Your Earning</span>
