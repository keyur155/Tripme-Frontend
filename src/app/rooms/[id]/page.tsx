  ...
  useEffect(() => {
    ...
    const updatePricing = async () => {
      ...
      const newPriceBreakdown = {
        ...
        extraGuestPrice: pricing.extraGuestPrice || (pricing.extraGuestCost && pricing.extraGuests && pricing.nights ? pricing.extraGuestCost / (pricing.extraGuests * pricing.nights) : 0),
