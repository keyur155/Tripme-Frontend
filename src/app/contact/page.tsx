        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12 sm:mb-16 text-center">
            <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-[#F5E6D3] rounded-xl sm:rounded-2xl mb-4 sm:mb-6">
              <Mail className="text-[#C45D3E] w-6 h-6 sm:w-8 sm:h-8" />
            </div>
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <section className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8 md:p-12">
              ...
              <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                {/* Email Support */}
                <div className="bg-[#FDF8F3] rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-[#F5E6D3]">
                  <div className="flex items-center mb-3 sm:mb-4">
                    <div className="bg-[#F5E6D3] p-2 sm:p-3 rounded-lg sm:rounded-xl mr-3 sm:mr-4 flex-shrink-0">
                      <Mail className="text-[#C45D3E] w-5 h-5 sm:w-6 sm:h-6" />
                    </div>
                  ...
                  <a 
                    ...
                    className="text-[#C45D3E] hover:text-[#A84B32] font-semibold text-sm sm:text-base md:text-lg break-all"
                  >
                ...
                <div className="bg-[#FDF8F3] rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-[#F5E6D3]">
                  <div className="flex items-center mb-3 sm:mb-4">
                    <div className="bg-[#F5E6D3] p-2 sm:p-3 rounded-lg sm:rounded-xl mr-3 sm:mr-4 flex-shrink-0">
                      <Send className="text-[#C45D3E] w-5 h-5 sm:w-6 sm:h-6" />
                    </div>
                    <div className="min-w-0">
            ...
            <section className="bg-[#FDF8F3] rounded-2xl sm:rounded-3xl shadow-sm border border-[#F5E6D3] p-6 sm:p-8 md:p-12">
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-[#F5E6D3]">
            ...
            <section className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8 md:p-12">
              <div className="flex items-center mb-4 sm:mb-6">
                <MapPin className="text-[#C45D3E] mr-2 sm:mr-3 flex-shrink-0 w-6 h-6 sm:w-7 sm:h-7" />
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
              <section className="bg-[#FDF8F3] rounded-2xl sm:rounded-3xl shadow-sm border border-[#F5E6D3] p-6 sm:p-8">
                <div className="flex items-center mb-3 sm:mb-4">
                  <HelpCircle className="text-[#C45D3E] mr-2 sm:mr-3 flex-shrink-0 w-5 h-5 sm:w-6 sm:h-6" />
                ...
                <p className="text-xs sm:text-sm text-gray-600">
                  Please email <a href="mailto:support@tripmeglobal.com" className="text-[#C45D3E] font-semibold hover:underline break-all">support@tripmeglobal.com</a> with your booking ID for faster assistance.
                </p>
              </section>

              <section className="bg-[#FDF8F3] rounded-2xl sm:rounded-3xl shadow-sm border border-[#F5E6D3] p-6 sm:p-8">
                <div className="flex items-center mb-3 sm:mb-4">
                  <MessageSquare className="text-[#C45D3E] mr-2 sm:mr-3 flex-shrink-0 w-5 h-5 sm:w-6 sm:h-6" />
                ...
                <p className="text-xs sm:text-sm text-gray-600">
                  Contact us at <a href="mailto:partners@tripmeglobal.com" className="text-[#C45D3E] font-semibold hover:underline break-all">partners@tripmeglobal.com</a>.
                </p>
              </section>
            </div>
            ...
            <section className="bg-[#FDF8F3] rounded-2xl sm:rounded-3xl shadow-sm border border-[#F5E6D3] p-6 sm:p-8 md:p-12">
              <div className="flex items-center mb-4 sm:mb-6">
                <MessageSquare className="text-[#C45D3E] mr-2 sm:mr-3 flex-shrink-0 w-6 h-6 sm:w-7 sm:h-7" />
              ...
              <a 
                ...
                className="inline-flex items-center text-[#C45D3E] hover:text-[#A84B32] font-semibold text-base sm:text-lg break-all"
              >
            ...
            {/* Stay Connected */}
            <section className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8 md:p-12 text-center">
